...
const LogInPage = () => {
    ...
    <div className="bg-stone-50 mb-2 p-6 sm:p-10 shadow-xl rounded-2xl w-full sm:max-w-125 space-y-3 hover:shadow-orange-200 transition-shadow">

        <div>
            <h1 className="font-bold text-stone-600 text-xl sm:text-2xl text-center mb-6">
                Login <span className="text-orange-500">with account</span>
            </h1>
        </div>
        ...
        <div>
            <form className="mt-6 space-y-4" onSubmit={handleSubmit(onSubmit)}>
                ...
                <fieldset className="fieldset relative">
                    ...
                    <button className="btn bg-orange-400 hover:bg-orange-600 text-white w-full mt-6 border-none">
                        Login
                    </button>
                </fieldset>

                <p className="text-center text-sm sm:text-base mt-4">
                    Don’t Have An Account? <Link href={'/register'} className="text-orange-500 font-semibold hover:underline">Register</Link>
                </p>
            </form>
